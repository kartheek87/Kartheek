...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 21, 2015 at 10:31 PM
...
(1, 'bread', 'eldorado', '55% off'),
(2, 'bread', 'skogaholm', '45% off'),
(3, 'bread', 'pagen', '45% off'),
(4, 'meat', 'kronfagel', '55% off'),
(5, 'milk', 'arla', '45% off'),
(6, 'milk', 'asens', '35% off'),
(7, 'cake', 'maxi product', '45% off');
...
(1, 'bread', 'eldorado', '40% off'),
(2, 'bread', 'finax', '50% off'),
(3, 'bread', 'lockarp', '45% off'),
(4, 'bread', 'pagen', '35% off'),
(5, 'bread', 'skogaholm', '55% off'),
(6, 'meat', 'guldfageln', '40% off'),
(7, 'meat', 'garant', '30% off'),
(8, 'meat', 'kronfagel', '55% off'),
(9, 'milk', 'arla', '45% off'),
(10, 'milk', 'garant', '45% off'),
(11, 'milk', 'skanemejerier', '30% off'),
(12, 'milk', 'asens', '35% off');
...
(1, 'bread', 'pagen', '45% off'),
(2, 'bread', 'lokarp', '55% off'),
(3, 'meat', 'guldfageln', '45% off'),
(4, 'milk', 'arla', '40% off'),
(5, 'milk', 'asens', '45% off');
...
(1, 'bread', 'pagen', '55% off'),
(2, 'meat', 'gyllda', '45% off'),
(3, 'meat', 'guldfageln', '50% off'),
(4, 'milk', 'asens', '55% off'),
(5, 'milk', 'garant', '40% off');
...
(1, 'bread', 'eldorado', '45% off'),
(2, 'bread', 'finax', '55% off'),
(3, 'bread', 'pagen', '40% off'),
(4, 'bread', 'skogaholm', '55% off'),
(5, 'meat', 'guldfageln', '40% off'),
(6, 'meat', 'kronfagel', '55% off'),
(7, 'milk', 'arla', '50% off');
